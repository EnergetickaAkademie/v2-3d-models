...
module bottom_tray() {
    difference() {
        ...
        //translate([case_min_x + case_width/2 - 7.5, case_max_y - 0.1, base_thickness + total_internal_height - 1.5])
        //cube([15, wall_thickness + 0.2, 1.6]);
    }
...
module top_lid() {
    ...
    // Modify these values to move the entire indent assembly on the lid
    ...
    difference() {
        ...
        translate([assembly_offset_x, assembly_offset_y, wall_thickness - socket_depth])
        union() {
